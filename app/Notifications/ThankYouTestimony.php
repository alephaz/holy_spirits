...
class ThankYouTestimony extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if (app()->getLocale() === 'it') {
            return (new MailMessage)
                ->subject('Grazie per averci inviato la tua testimonianza')
                ->line('È una benedizione ascoltare ciò che il Signore ha fatto nella tua vita mediante il potere dello Spirito Santo. Ci rallegriamo con te e diamo gloria a Dio! Grazie per aver condiviso la tua storia con noi!!')
                ->line('Ti ringraziamo anche per amarci e sostenerci mentre continuiamo ad andare in tutto il mondo per condividere la buona notizia di Gesù')
